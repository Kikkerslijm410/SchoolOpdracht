...
public abstract class ExcelManager {
    ...
    public static void Start() throws IOException{
        ...
        Vulplanning.put("5", new Object[] {"", "", "", "Potjes"});
        Vulplanning.put("6", new Object[] {"", "", "", "Frisdrank"});
        Vulplanning.put("7", new Object[] {"", "", "", "Bier"});
        Vulplanning.put("8", new Object[] {"", "", "", "Wijn"});
        Vulplanning.put("9", new Object[] {"", "", "", "Chips"});
        Vulplanning.put("10", new Object[] {"", "", "", "Cosmetica"});
        Vulplanning.put("11", new Object[] {"", "", "", "Dierenvoeding"});
        Vulplanning.put("12", new Object[] {"", "", "", "Koek"});
        Vulplanning.put("13", new Object[] {"", "", "", "Ontbijt"});
        Vulplanning.put("14", new Object[] {"", "", "", "Zuivel"});
        Vulplanning.put("15", new Object[] {"", "", "", "VVP"});
        Vulplanning.put("16", new Object[] {"", "", "", "Diepvries"});
        Vulplanning.put("17", new Object[] {});
        Vulplanning.put("18", new Object[] {});
        Vulplanning.put("19", new Object[] {});
        Vulplanning.put("20", new Object[] {});
        Vulplanning.put("21", new Object[] {});
        Vulplanning.put("22", new Object[] {});
        Vulplanning.put("23", new Object[] {});
        Vulplanning.put("24", new Object[] {});
        Vulplanning.put("25", new Object[] {});
        Vulplanning.put("26", new Object[] {});
        Vulplanning.put("27", new Object[] {});
        Vulplanning.put("28", new Object[] {});
